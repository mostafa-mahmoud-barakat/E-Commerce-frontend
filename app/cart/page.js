...
function Cart() {
    ...
    const deleteCartItemFromList=(id)=>{
       CartApis.deletCartItem(id).then((res)=>{
            ...
            <section>
              <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
                ...
                <div className="mt-8">
                    <ul className="space-y-4">
                        {cart.map((item)=>(
                             <li key={item?.id} className="flex items-center gap-4">
                                  ...
                                  <div>
                                  <h3 className="text-sm text-gray-900">{item?.product?.attributes?.banner?.data?.attributes?.title}</h3>
                    ...
                    <h2 className='text-gray-400 text-[12px]'>Note: All Items will be sent via Email Address</h2>
                </div>
                </div>
            </div>
            </section>
