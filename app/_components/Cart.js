...
function Cart() {
  ...
  return (
    <div className='h-[300px] w-[250px] bg-gray-100 rounded-md border shadow-sm absolute mx-10 right-10 
    top-12 p-5 overflow-auto'>
           ...
           <div className="space-y-4 text-center mt-5">
                <Link
                    href="/cart"
                    className="block rounded border border-gray-600 px-5 py-3 text-sm text-gray-100 bg-gray-700 transition hover:ring-1 hover:ring-gray-400"
                >
